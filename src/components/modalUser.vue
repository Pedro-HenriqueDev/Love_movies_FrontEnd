    ...
    <div class="flex flex-col items-center pb-10">
        ...
        <div class="flex flex-col mt-4 space-x-3 md:mt-6">
            <div class="flex">
                ...
                <button @click="pass? pass = false: pass = true" type="button" class="text-gray-900 bg-red-600 border focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:text-white dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Apagar Conta</button>
            </div>
            <div v-if="pass">
                ...
                <button @click="erasedAccout" type="button" class="text-gray-900 bg-red-600 border focus:outline-none hover:bg-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:text-white dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">Apagar</button>
